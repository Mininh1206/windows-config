...
[![Catalog](https://img.shields.io/badge/Cat%C3%A1logo-75%20Apps%20Validadas-success)](aplicaciones.md)
...
- **📦 Catálogo de 75 Aplicaciones:** 9 categorías completas (UX/UI, IDEs, Frameworks, Herramientas, Virtualización, Ágil, Navegadores, Utilidades y Juegos).
...
## 📂 Categorías de Software Incluidas (75 Apps)
...
| **Herramientas** | Git, Docker Desktop, GitHub Desktop, Claude Code, OpenCode, Hermes Agent (Soul), Ollama, LM Studio, XAMPP, Postman. |
| **Virtualización** | VMware Workstation Pro, WSL2 (Ubuntu), Oracle VirtualBox. |
...
Consulta el inventario completo en [`aplicaciones.md`](aplicaciones.md).
...
- [Matriz y Checklist de Aplicaciones](aplicaciones.md)
- [Manual de Uso Extendido](MANUAL.md)
- [Arquitectura y Esquema de Manifiestos](arquitectura.md)
